...
kg/sideNav/2.0.0/mods/tool
kg/sideNav/2.0.0/mods/normal
kg/sideNav/2.0.0/mods/fade
kg/sideNav/2.0.0/mods/zoom
kg/sideNav/2.0.0/mods/rotate
kg/sideNav/2.0.0/mods/blur
kg/sideNav/2.0.0/mods/blink
...
KISSY.add('kg/sideNav/2.0.0/mods/tool',function (S) {
...
KISSY.add('kg/sideNav/2.0.0/mods/normal',function (S, Node, Anim, Base, Tool) {
	var EMPTY = '';
    var $ = Node.all;
...
KISSY.add('kg/sideNav/2.0.0/mods/fade',function (S, Node, Anim, Base, Tool) {
	var EMPTY = '';
    var $ = Node.all;
...
KISSY.add('kg/sideNav/2.0.0/mods/zoom',function (S, Node, Anim, Base, Tool) {
	var EMPTY = '';
    var $ = Node.all;
    ...
    var Zoom = {
    	...
    	show: function(cxt) {
            ...
            if (Tool.isSupportTransform 
                ...
                }, cfg.duration/2.0.00, cfg.easing);
            }
    	},
    	/**
    	 * 隐藏
...
KISSY.add('kg/sideNav/2.0.0/mods/rotate',function (S, Node, Anim, Base, Tool) {
	var EMPTY = '';
    var $ = Node.all;
...
KISSY.add('kg/sideNav/2.0.0/mods/blur',function (S, Node, Anim, Base, Tool) {
	var EMPTY = '';
    var $ = Node.all;
...
KISSY.add('kg/sideNav/2.0.0/mods/blink',function (S, Node, Anim, Base, Tool) {
	var EMPTY = '';
    var $ = Node.all;
 ...
 * @module sideNav
 **/
KISSY.add('kg/sideNav/2.0.0/index',function (S, Node, Anim, Base, Normal, Fade, Zoom, Rotate, Blur, Blink, Tool) {
